    ...
    <div class="chat-section layout-top-spacing">
      <div class="widget-content widget-content-area br-6">
        <div class="table-responsive mb-4 mt-4">
          <h1>Buyer  
          <span class="btn btn-info btn-sm pull-right">Total Buyer <span style="color:#ffeb00">{{count($userlist)}}</span></span>
          </h1>
                <table class="table" id="user">
                  ...
                  <tbody>
                   ...
                   <tr>
                      ...
                      <td>@if($row->main_user_type == 0)
                      <span class="badge badge-danger user-change" data-id="{{ $row->id }}" data-status="{{ $row->main_user_type }}"> Buyer</span>
                      @endif
                      </td>
                   </tr>
                   @endforeach
...
<script type="text/javascript">
  $(".user-change").click(function () {
    if (confirm("Are you sure you provide supplier this user?"))
    var id = $(this).data("id");
