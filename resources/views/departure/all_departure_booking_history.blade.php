   ...
   <div class="chat-section layout-top-spacing">
    <div class="widget-content widget-content-area br-6">
     <div class="table-responsive mb-4 mt-4">
                <h1>All Booking History <a href="" class="btn btn-info btn-sm pull-right">Total Booked {{$total}}</a></h1>
                ...
                <tr>
                <td>{{$key+1}}</td>
                <td> <a href="{{url('/departure/booking/history/details/'.$row->id)}}" style="text-decoration:none;">{{$row->title}}</a></td>
